...
<p>Your {{ ucfirst($plan) }} plan subscription of {{ $transaction->amount->getAmount()->toFloat() }} {{ $transaction->currency }} billed at {{ $billed_at }} {{ $transaction->currency }} has been renewed.</p>
