...
<p>You have purchased {{ $units }} of {{ $vendType }} {{ $company }} to {{ $recipient }} costing {{ $transaction->amount->getAmount()->toFloat() }} {{ $transaction->currency }} is successful. The token is {{ $token }}</p>
