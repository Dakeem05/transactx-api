 ...
 extends Notification implements ShouldQueue
{
    ...
    {
        return (new MailMessage)->subject('Transfer Reversed 💸')
            ->markdown(
                'email.user.transactions.transfer-reversed',
    ...
    public function toFCM(object $notifiable): CloudMessage
    {
        ...
        $body = "Your transfer of $this->transactionCurrency $this->transactionAmount to $this->recipientFirstName $this->recipientLastName failed and your funds reversed.";
        ...
        return CloudMessage::new()
            ...
            ->withData([
                'notification_key' => 'transfer-reversed',
            ]);
    }
    ...
    public function toArray(object $notifiable): array
    {
        return [
            'title' => 'Transfer Reversed 💸',
            'message' => "Your transfer of $this->transactionCurrency $this->transactionAmount to $this->recipientFirstName $this->recipientLastName failed and your funds reversed.",
            'data' => [
